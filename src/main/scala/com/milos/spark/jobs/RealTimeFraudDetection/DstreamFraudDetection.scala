package com.milos.spark.jobs.RealTimeFraudDetection

import com.milos.cassandra.dao.{KafkaOffsetRepository, CreditcardTransactionRepository}
import com.milos.cassandra.{CassandraDriver, CassandraConfig}
import com.milos.config.Config
import com.milos.creditcard.Schema
import com.milos.kafka.KafkaConfig
import com.milos.spark.{DataReader, GracefulShutdown, SparkConfig}
import com.milos.spark.jobs.SparkJob
import com.milos.utils.Utils
